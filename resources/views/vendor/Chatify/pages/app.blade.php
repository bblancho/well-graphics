...
<div class="messenger">
        ...
        <div class="m-header">
            ...
            <div class="messenger-listView-tabs">
                <a href="#" @if($route == 'user') class="active-tab" @endif data-view="users">
                    <span class="far fa-user"></span> Membres</a>
            </div>
        </div>
        {{-- tabs and lists --}}
        <div class="m-body">
           ...
           <div class="messenger-tab app-scroll" data-view="search">
                ...
                <div class="search-records">
                    <p class="message-hint"><span>Ecrivez pour chercher</span></p>
                </div>
             </div>
        </div>
    </div>
    ...
    <div class="messenger-messagingView">
        ...
        <div class="m-body app-scroll">
            <div class="messages">
                <p class="message-hint" style="margin-top: calc(30% - 126.2px);"><span>Choisissez une discussion pour commencer</span></p>
            </div>
            {{-- Typing indicator --}}
